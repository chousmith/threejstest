console.log('hello. lets do this...');
...
textureLoader.load("https://www.3dxo.com/images/textures/m/wildgrass_2_ur_1024.png", texture => {
  var coneGeometry = new THREE.ConeGeometry( 0.5, 1, 4 );
...
document.body.title = 'drag to move';
document.body.style="margin:0; cursor:move";
